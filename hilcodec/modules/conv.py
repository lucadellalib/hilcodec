...
from hilcodec.modules.norm import ConvLayerNorm
from hilcodec.modules.weight_standardization import weight_standardization
...
def apply_parametrization_norm(
    module: nn.Module, norm: str = "none", **norm_kwargs
) -> nn.Module:
...
class CausalSTFT(nn.Module):
    ...
    def __init__(
        ...
        n_fft: int,
        hop_size: int,
        win_size: tp.Optional[int] = None,
        win_type: tp.Optional[str] = "hann",
        window: tp.Optional[Tensor] = None,
